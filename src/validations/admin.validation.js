...
const { requiredString, requiredNumber, emailFieldOptional, emailField, nameField, mobileNumberField, aadhaarNumberField, panNumberField, imageField } = require('./fieldHelpers');
